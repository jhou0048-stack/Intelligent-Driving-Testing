...
This repository is a simulation-based ADAS testing and validation portfolio project built with Python, CARLA, PyTest, OpenCV, YOLO, and Pandas.
...
- Keep CARLA-specific integration inside `simulation`; other packages should depend on small, explicit interfaces rather than simulator internals.
...
- Target Python 3.10 or later and add type hints to new public interfaces.
